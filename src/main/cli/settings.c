...
// PG_OSD_CONFIG
    ...
    { "osd_adh_cam_angle",          VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 900 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_cam_angle) },
    { "osd_adh_cam_ver_fov",        VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 2000 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_cam_ver_fov) },
    ...
    { "osd_adh_mark1_deg",          VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 900 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_deg) },
    ...
    { "osd_adh_mark2_deg",          VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 900 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_deg) },
    ...
    { "osd_adh_mark3_deg",          VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 900 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_deg) },
