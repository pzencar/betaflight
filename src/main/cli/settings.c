...
// PG_OSD_CONFIG
    ...
    { "osd_adh_cam_angle",          VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 90 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_cam_angle) },
    { "osd_adh_cam_ver_fov",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_cam_ver_fov) },
    { "osd_adh_roll_factor",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_roll_factor) },
    { "osd_adh_size",               VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 20 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_size) },
    { "osd_adh_l_sym",              VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_l_sym) },
    { "osd_adh_r_sym",              VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_r_sym) },
    { "osd_adh_mark1_deg",          VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_deg) },
    { "osd_adh_mark1_size",         VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 10 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_size) },
    { "osd_adh_mark1_l_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_l_sym) },
    { "osd_adh_mark1_r_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_r_sym) },
    { "osd_adh_mark1_d_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark1_d_sym) },
    { "osd_adh_mark2_deg",          VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_deg) },
    { "osd_adh_mark2_size",         VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 10 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_size) },
    { "osd_adh_mark2_l_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_l_sym) },
    { "osd_adh_mark2_r_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_r_sym) },
    { "osd_adh_mark2_d_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark2_d_sym) },
    { "osd_adh_mark3_deg",          VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_deg) },
    { "osd_adh_mark3_size",         VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 10 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_size) },
    { "osd_adh_mark3_l_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_l_sym) },
    { "osd_adh_mark3_r_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_r_sym) },
    { "osd_adh_mark3_d_sym",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_mark3_d_sym) },
    { "osd_adh_lock_roll",          VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_lock_roll) },
    { "osd_adh_invert_roll",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_invert_roll) },
    { "osd_adh_invert_pitch",       VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_invert_pitch) },
    ...
    { "osd_adh_pos",                VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_ADVANCED_HORIZON]) },
