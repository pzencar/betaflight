...
// PG_OSD_CONFIG
    ...
    { "osd_adh_cam_ver_fov",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_cam_ver_fov) },
    ...
    { "osd_adh_size",               VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 1, 10 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_size) },
    { "osd_adh_left_symbol",        VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_left_symbol) },
    { "osd_adh_right_symbol",       VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_right_symbol) },
    ...
    { "osd_adh_g_multiplier",       VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 255 }, PG_OSD_CONFIG, offsetof(osdConfig_t, adh_g_multiplier) },
